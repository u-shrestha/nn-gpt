...
from ab.gpt.util.Const import nngpt_dir, new_out_file, trans_dir
from ab.gpt.util.TuneTransform import tune, ds_conf
...
LLM_TUNE_CONF = 'Transform_gen.json'
NN_GEN_CONF = 'Transform_gen.json'
