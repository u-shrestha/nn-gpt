...
def main(nn_name_prefix=NN_NAME_PREFIX, nn_train_epochs=NN_TRAIN_EPOCHS, save_to_db=SAVE_TO_DB, nn_alter_epochs=NN_ALTER_EPOCHS,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '-nae', '--nn_alter_epochs', type=int, default=NN_ALTER_EPOCHS,
        help="Number of epochs NNAlter.py was run for (e.g., if NNAlter's -e was 8, use 8 here)."
    )
    parser.add_argument(
        '-nte', '--nn_train_epochs', type=int, default=NN_TRAIN_EPOCHS,
    ...
    parser.add_argument(
        '--transform', type=str, default=TRANSFORM,
    ...
    parser.add_argument(
        '--save_to_db', action=argparse.BooleanOptionalAction, default=SAVE_TO_DB,
    ...
    main(args.nn_name_prefix, args.nn_train_epochs, args.save_to_db, args.nn_alter_epochs,
