...
def main(nn_alter_epochs, nn_train_epochs, task, dataset, metric, lr, batch_size, dropout, momentum, transform, save_to_db, nn_name_prefix):
    ...
    for i in range(nn_alter_epochs):
        ...
        for model_folder_name in os.listdir(models_base_dir):
            ...
            try:
                ...
                if nn_name_prefix:
                    nn_name = nn_name_prefix + '-' + nn_name
...
if __name__ == "__main__":
    ...
    main(args.nn_alter_epochs, args.nn_train_epochs, args.task, args.dataset, args.metric,
         args.lr, args.batch_size, args.dropout, args.momentum, args.transform, args.save_to_db, args.nn_name_prefix)
