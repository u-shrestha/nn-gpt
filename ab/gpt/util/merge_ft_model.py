...
from ab.gpt.util.Const import small_llm, nngpt_out, epoch_dir, llm_tokenizer_out, nngpt_upload
...
def merge_nn_llm():
    add_tokenizer(nngpt_out, llm_tokenizer_out, nngpt_upload, small_llm)
