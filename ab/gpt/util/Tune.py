...
def tune(test_nn, nn_epoch, skip_epoch, llm_path, llm_tune_conf, nn_gen_conf, conf_keys, llm_conf,
    ...
    def apply_sliding_window(example, max_length=1024, stride=512):
