...
class Net(nn.Module):
    ...
    def forward(self, x):
        ...
        def train_setup(self, prm):
            old_optim_state_dict = self.optimizer.state_dict() if hasattr(self, 'optimizer') else None
            ...
            if old_optim_state_dict is not None:
                self.optimizer.load_state_dict(old_optim_state_dict)
